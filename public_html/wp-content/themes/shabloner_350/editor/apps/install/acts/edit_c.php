...
if($_POST)
{
	...
	if($settings['font_title_path'])
	{
		$font_css_file = api('download.css_url', array($settings['font_title_path'], $settings['font_title_path'], $folder.'/fonts'));
		$fonts_include .= '<link rel="stylesheet" href="[template_directory]fonts/'.$font_css_file['name'].'" type="text/css" />'."\n";
	}

	if($settings['font_text_path'])
	{
		$font_css_file = api('download.css_url', array($settings['font_text_path'], $settings['font_text_path'], $folder.'/fonts'));
		$fonts_include .= '<link rel="stylesheet" href="[template_directory]fonts/'.$font_css_file['name'].'" type="text/css" />';
	}
