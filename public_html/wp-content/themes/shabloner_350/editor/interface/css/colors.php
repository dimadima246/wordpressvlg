...
$color = "#307ECC"; // Change your Color Here
...
.entry:after, .btn-primary { background-color: <?php echo $color; ?>; }

.btn-primary { border-color: <?php echo $color; ?>; }
...
.page-link:hover,
.page-link:focus, .badge-primary { background-color: <?php echo $color; ?> !important; }
