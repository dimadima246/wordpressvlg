	...
	<div class="slider-parallax-inner">
		...
		<div class="swiper-container swiper-parent">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide dark" style="background-image: url('<?=get_template_directory_uri()?>/files/ct_block_item_133337_628721_6_image_DS8BB4Z1.jpg');">
				    <div class="overfill" style="background-color: rgba(0, 0, 0, 0.40);"></div>
					<div class="container clearfix">
						<div class="slider-caption slider-caption-center">
							<h2 class=" editable block_133337 item item-field_title item-option_305679 item-int_628721">Российская Федерация</h2>
							
							<p class="d-none d-sm-block editable block_133337 item item-field_text item-option_5 item-int_628721">"Волгоградский региональный правозащитный Центр"</p>
